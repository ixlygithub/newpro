...
<head>
	...
	<!-- Fonts -->
	<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/fontfaceobserver/2.0.4/fontfaceobserver.standalone.min.js"></script>
			...
			<section class="row">
				<div class="col-md-9 no_padding">
					...
					<div class="home_signin">
						<h3>HOME / QUESTIONS / NCLEX MASTERY QUESTIONS</h3>
					</div>
					<div class="bgcolour">
						<div class="row">
				            <div class="col-md-3">
				                ...
				                <div class="nav flex-column nav-pills nav-pills-custom" id="v-pills-tab" role="tablist" aria-orientation="vertical">
				                    ...
				                    <a class="nav-link mb-3 p-3 shadow" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">
				                        ...
				                        <span class="font-weight-bold small text-uppercase">Don't know</span></a>

				                    <a class="nav-link mb-3 p-3 shadow" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false">
				                        <i class="fa fa-star mr-2"></i>
				                        <span class="font-weight-bold small text-uppercase">Somewhat</span></a>

				                    <a class="nav-link mb-3 p-3 shadow" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false">
				                        <i class="fa fa-check mr-2"></i>
				                        <span class="font-weight-bold small text-uppercase">know</span></a>

				                    <a class="nav-link mb-3 p-3 shadow" id="v-pills-save-tab" data-toggle="pill" href="#v-pills-save" role="tab" aria-controls="v-pills-save" aria-selected="false">
				                        <i class="fa fa-bookmark mr-2"></i>
				                        <span class="font-weight-bold small text-uppercase">save</span></a>
				                    </div>
				            </div>
				            ...
				            <div class="col-md-9">
				                ...
				                <div class="tab-content" id="v-pills-tabContent">
				                    <div class="tab-pane fade shadow rounded bg-white p-5 active show" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
				                       <div class="table-responsive">
											<table class="table table-striped">
												...
												<tbody>
													<tr>
														<th scope="row">2268</th>
														<td>---------------------</td>
														<td>Study All Times</td>
													</tr>
													<tr>
														<th scope="row">849</th>
														<td>---------------------</td>
				                    ...
				                    <div class="tab-pane fade shadow rounded bg-white p-5" id="v-pills-save" role="tabpanel" aria-labelledby="v-pills-save-tab">
				                    </div>
				                </div>
				            </div>
        				</div>
