...
<a href="http://simplestepscode.com/" target="_blank">Simple Steps Code</a> -->
           ...
           <!-- <button onclick="pauseAudio()" type="button" class="btn btn-warning">Pause <i class="far fa-pause-circle"></i></button> 
             ...
             <button onclick="mute_unmutebuzzerAudio()" title="Wrong Answer buzzer" type="button" class="btn buzzerbtntext">Mute Music Memory Mode<i class="far fa-pause-circle"></i></button> 
          <div class="row qt_div">
						<div class="col-md-7">
						<!-- <div class="question">
...
">
    ...
    margin-top: 79px;
    margin-right: -211px;"><i class="far fa-play-circle"></i> STEM MODE ON</button>
...
function playAudio() { 
  if(x.paused){
     x.play(); 
      $('.btntext').html('<i class="far fa-pause-circle"></i> STEM MODE ON');
       $('.btntext').removeClass('stembtnclr');
  }else{
    x.pause();
    $('.btntext').html('<i class="far fa-play-circle"></i> STEM MODE OFF');
