...
<audio id="buzzer" controls style="display: none">
  <source src="<?php echo url('/public/images/Buzzer-sound.mp3')?>" type="audio/ogg">
  <source src="<?php echo url('/public/images/Buzzer-sound.mp3')?>" type="audio/mpeg">
  Your browser does not support the audio element.
</audio>
			<header class="">
				<div class="banner">
           ...
           <!-- <button onclick="pauseAudio()" type="button" class="btn btn-warning">Pause <i class="far fa-pause-circle"></i></button> 
             ...
             <button onclick="mute_unmutebuzzerAudio()" type="button" class="btn btn-warning buzzerbtntext">Mute Music Memory Mode<i class="far fa-pause-circle"></i></button> 
          <div class="row qt_div">
						<div class="col-md-7">
						<!-- <div class="question">
...
">
					...
					<button onclick="playAudio()" type="button" class="btn btn-success btntext btn-grad" id="ss"><i class="far fa-play-circle"></i> Play</button>
...
function playAudio() { 
  if(x.paused){
     x.play(); 
      $('.btntext').html('<i class="far fa-pause-circle"></i> Play');
    
  }else{
    x.pause();
    $('.btntext').html('<i class="far fa-play-circle"></i> Pause');
...
function mute_unmutebuzzerAudio(){
  if (xb.muted === false) {    
       xb.muted = true;
       $('.buzzerbtntext').html('UnMute Music Memory Mode<i class="far fa-play-circle"></i>');
  }else{
      xb.muted = false;
      $('.buzzerbtntext').html('Mute Music Memory Mode<i class="far fa-pause-circle"></i>');
  }
