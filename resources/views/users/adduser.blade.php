...
<div class="container">
        ...
        <div class="card">  
          ...
          <form action="{{ route('adduser') }}" method="post">
            ...
            <div class="form-group">
             ...
             <select  class="form-control role" name="role" value="{{ old('role') }}"  placeholder="Enter Role" onchange="privilege(this.value)">
  ...
  border-radius: 12px;">
           ...
           <label class="checkbox-inline">
            ...
            <div class="col-md-6">
            <label class="checkbox-inline">
              <input type="checkbox" value="feedback" name="privileges[]"> Feedback
            </label>
            ...
            <div class="col-md-6">
            <label class="checkbox-inline">
              <input type="checkbox" value="reports" name="privileges[]" > User
            </label>
            <label class="checkbox-inline">
              <input type="checkbox" value="questionreports" name="privileges[]" > Category 
            </label>
           <label class="checkbox-inline">
              <input type="checkbox" value="weightagereports" name="privileges[]" > Weightage
            </label>
            <label class="checkbox-inline">
              <input type="checkbox" value="websitereport" name="privileges[]" > Website performance
            </label>
            <label class="checkbox-inline">
              <input type="checkbox" value="audioreport" name="privileges[]" > Audio
            </label>
            </div>
            </div>
