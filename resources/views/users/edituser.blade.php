        ...
        <div class="card">  
          ...
          <form action="{{ route('updateuser',$user->id) }}" method="post">
            ...
            <div class="form-group">
             ...
             <select  class="form-control" name="status"   placeholder="Enter status" >
               <option value='2' {{ ($user->status=="2") ? 'selected' : '' }}>Trial </option>
           ...
           <label class="checkbox-inline">
            ...
            <div class="row">
            <div class="col-md-6">
            <ul><li><label>Feed back</label></li></ul>
            </div>
            <div class="col-md-6">
            <label class="checkbox-inline">
              <input type="checkbox" value="feedback" name="privileges[]" <?php echo (in_array("feedback", $privileges))?'checked':'';?>> Feedback
            </label>
            ...
            <div class="row">
            <div class="col-md-6">
            <ul><li><label>Reports</label></li></ul>
            </div>
            <div class="col-md-6">
            <label class="checkbox-inline">
              <input type="checkbox" value="reports" name="privileges[]" <?php echo (in_array("reports", $privileges))?'checked':'';?>> User
            </label>
            <label class="checkbox-inline">
              <input type="checkbox" value="questionreports" name="privileges[]" <?php echo (in_array("questionreports", $privileges))?'checked':'';?>> Category 
            </label>
           <label class="checkbox-inline">
              <input type="checkbox" value="weightagereports" name="privileges[]" <?php echo (in_array("weightagereports", $privileges))?'checked':'';?>> Weightage
            </label>
            <label class="checkbox-inline">
              <input type="checkbox" value="websitereport" name="privileges[]" <?php echo (in_array("websitereport", $privileges))?'checked':'';?>> Website performance
            </label>
            <label class="checkbox-inline">
              <input type="checkbox" value="audioreport" name="privileges[]" <?php echo (in_array("audioreport", $privileges))?'checked':'';?>> Audio
            </label>
            </div>
            </div>
                <input type="hidden" value="profile" name="privileges[]" class="checkbox">
